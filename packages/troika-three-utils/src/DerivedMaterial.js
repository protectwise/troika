...
export function createDerivedMaterial(baseMaterial, options) {
  ...
  const generateUUID = function() {
    // copied three.MathUtils to preserve compatibility with three versions before 0.113.0 as it was changed from Math to MathUtils in that version.
    // https://github.com/mrdoob/three.js/blob/dd8b5aa3b270c17096b90945cd2d6d1b13aaec53/src/math/MathUtils.js#L16

    // *this function is copied from this message onwards*
