...
class TextExample extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      outlineOpacity: 1,
      outline: 0,
      outlineToShadow: false,
      outlineInsetShadow: false,
      fog: false,
      animTextColor: true,
      animTilt: true,
      animRotate: false,
          ...
          objects={ [
            {
              ...
              onlyBorderThickness: state.onlyBorderThickness,
              outlineWidth: state.outlineWidth,
              outlineOffsetX: state.outlineOffsetX,
              outlineOffsetY: state.outlineOffsetY,
              outlineOpacity: state.outlineOpacity,
              outlineToShadow: state.outlineToShadow,
              outlineInsetShadow: state.outlineInsetShadow,
              material: material,
              color: 0xffffff,
            ...
            } : null,
            {
              ...
              items: [
                ...
                {type: 'number', path: "onlyBorderThickness", min: 0, max: 0.005, step: 0.0001},
                ...
                {type: 'boolean', path: "outlineToShadow", label: "OutlineToShadow"},
                {type: 'boolean', path: "outlineInsetShadow", label: "Inset shadow"},
