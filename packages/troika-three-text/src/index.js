...
export { configureTextBuilder, fontProcessorWorkerModule, preloadFont, dumpSDFTextures } from './TextBuilder.js'
...
export { RangeHighlight } from './selection/RangeHighlight.js'
